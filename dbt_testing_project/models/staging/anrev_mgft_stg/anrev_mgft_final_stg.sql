with base as (
    ...
    from {{ref('anrev_mgft_transform_stg') }} t
    join {{ref('anrev_mgft_feecost_stg') }} fc on t.vehicle_detail_id = fc.vehicle_detail_id and t.year_reporting_date = fc.year_reporting_date
    join {{ref('anrev_mgft_metrics_stg') }} m on t.vehicle_detail_id = m.vehicle_detail_id and t.year_reporting_date = m.year_reporting_date
)
